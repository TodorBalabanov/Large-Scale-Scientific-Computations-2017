...
\begin{figure}
    \centering
    \subfloat[Function]{{\includegraphics[width=6cm,height=6cm]{fig03.png} }}
    \subfloat[Derivative]{{\includegraphics[width=6cm,height=6cm]{fig04.png} }}
...
\begin{figure}
    \centering
    \subfloat[Function]{{\includegraphics[width=6cm,height=6cm]{fig01.png} }}
    \subfloat[Derivative]{{\includegraphics[width=6cm,height=6cm]{fig02.png} }}
...
\begin{figure}
    \centering
    \subfloat[MLP Error]{{\includegraphics[width=6cm,height=6cm]{fig05.png} }}
    \subfloat[Training Epochs]{{\includegraphics[width=6cm,height=6cm]{fig06.png} }}
